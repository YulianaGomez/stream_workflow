...
set nf [open multi.nam w]
$ns namtrace-all $nf

#Open the Trace file
set tf [open multi.tr w]
$ns trace-all $tf
...
proc finish {} {
        ...
        exec gawk -f throughput.awk multi.tr > multi.xg
        exit 0
}
...
create_tcp_connection 2 4 3 
create_tcp_connection 2 5 4 
create_tcp_connection 3 6 5 
create_tcp_connection 3 7 6

create_tcp_connection 1 8 7
create_tcp_connection 8 2 8
create_tcp_connection 8 5 9

create_tcp_connection 8 4 10
...
$ns at 5.0 "$ftp(1) stop"
$ns at 5.0 "$ftp(4) stop"
$ns at 5.0 "$ftp(7) start"
$ns at 5.0 "$ftp(8) start"
$ns at 5.0 "$ftp(9) start"

$ns at 10.0 "$ftp(8) stop"
$ns at 10.0 "$ftp(3) stop"
$ns at 10.0 "$ftp(10) start"
